...
@section('admin')
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class="md:flex md:justify-between justify-center items-center px-4">
            <h1 class="text-3xl font-semibold text-center mb-5">Tambah Jenis Surat</h1>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Jenis
                                Surat</span>
                        </div>
                    </li>
                </ol>
        ...
        <form class="p-4 md:p-5" action="{{ route('jenissurat.store') }}" method="POST">
            @csrf
            @method('POST')
            <input type="hidden" name="id" value="">

            <h1 class="mb-8 text-3xl font-semibold">Tambah Jenis Surat</h1>
            ...
            <div class="grid gap-4 mb-4 md:grid-cols-4 grid-cols-1">
                <div class="col-span-2">
                    ...
                    <input id="nama_jenis" rows="4" type="text"
                        ...
                        placeholder="Masukkan Nema Jenis Surat..." name="nama_jenis" value="{{ old('nama_jenis') }}">
                </div>
            </div>
