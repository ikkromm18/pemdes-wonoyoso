        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap">Pengajuan Surat</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('pengajuan.disetujui') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 ">Pengajuan
                            Disetujui</a>
                    </li>

                    <li>
                        <a href="{{ route('pengajuan.ditolak') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 ">Pengajuan
                            Ditolak</a>
                    </li>
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap">User</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
                ...
                <ul id="dropdown-example1" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('user.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 ">User</a>
                    </li>
                    <li>
    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 text-center md:p-5">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda Yakin Ingin Melakukan
                    Log Out ?</h3>
