        ...
        <div class="hero-content flex-col lg:flex-row-reverse shadow-xl p-4">
            ...
            <div>
                ...
                <p class="py-6 pr-0 md:pr-20 text-center md:text-left">
                    ...
                    Melalui platform ini, masyarakat dapat mengakses berbagai layanan administrasi seperti pembuatan
                    surat keterangan, permohonan dokumen, dan informasi seputar kegiatan desa. Harapan kami, website ini
                    dapat menjadi jembatan yang mempermudah kebutuhan administrasi tanpa harus terkendala waktu dan
                    jarak.
