    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="{{ route('home') }}"
                        class="block py-2 px-3 text-gray-900 bg-blue-700 rounded md:bg-transparent md: md:p-0 dark:text-white md:dark:"
                ...
                <li>
                    <x-my-button href="{{ route('layanan') }}" class="text-white bg-primary">
                        Login
                    </x-my-button>
                </li>
