{{-- <nav class="sticky top-0 z-10 bg-white border-gray-200 shadow-md">
    <div
        class="flex flex-wrap items-center justify-between max-w-screen-xl gap-8 p-4 px-4 mx-auto md:justify-normal md:px-16">
        ...
        <button data-collapse-toggle="navbar-default" type="button"
            ...
            <svg class="w-5 h-5" aria-hidden="true" viewBox="0 0 17 14" fill="none"
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li><a href="{{ route('home') }}" class="block px-3 py-2 hover:text-blue-700">Beranda</a></li>
                <li><a href="#tatacara" class="block px-3 py-2 hover:text-blue-700">Services</a></li>
                <li><a href="#sambutan" class="block px-3 py-2 hover:text-blue-700">Tentang</a></li>
                <li><a href="{{ route('layanan') }}" class="block px-3 py-2 hover:text-blue-700">Layanan</a></li>

                @auth
                    @if (Auth::user()->role === 'Admin')
                        <li><a href="{{ route('dashboard') }}" class="block px-3 py-2 hover:text-blue-700">Dashboard</a>
                        </li>
                    @else
                        <li><a href="{{ route('profile.edit') }}"
                                class="block px-3 py-2 hover:text-blue-700">{{ Auth::user()->name }}</a></li>
                    @endif
                    <li>
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                            class="block px-3 py-2 hover:text-red-600">
                            Log Out
                        </button>
                    </li>
                @else
                    <li><a href="{{ route('login') }}"
                            class="block px-3 py-2 hover:text-blue-700 justify-self-end">Login</a></li>
                @endauth
            </ul>
        </div>
    </div>
